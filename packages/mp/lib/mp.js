...
module.exports.fetchTempMedia = async (mediaId) => {
    const token = await module.exports.getAccessToken();

    return await axios.get(`https://api.weixin.qq.com/cgi-bin/media/get?access_token=${token.data.access_token}&media_id=${mediaId}`);
}
